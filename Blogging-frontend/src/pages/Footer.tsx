        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white">
            ...
            <div className="flex space-x-4 justify-center md:justify-start mb-4">
              <a
                href="https://github.com/viratdogra1982"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/virat-dogra-158264327/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-indigo-800 p-2 rounded-full hover:bg-indigo-700 transition-colors duration-200"
                title="LinkedIn"
              ...
              <a
                href="mailto:viratd918@gmail.com"
                className="bg-indigo-800 p-2 rounded-full hover:bg-indigo-700 transition-colors duration-200"
                title="Email"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <p className="text-slate-300 font-serif mb-4">
              Made with ❤️ by <span className="bg-gradient-to-r from-purple-200 to-indigo-200 text-transparent bg-clip-text font-semibold">Virat Dogra</span>
            </p>
            ...
            <div className="text-slate-300 font-serif space-y-2">
              <p className="flex items-center">
                ...
                <a href="mailto:viratd918@gmail.com" className="hover:text-indigo-300 transition-colors duration-200">
                  viratd918@gmail.com
                </a>
              </p>
              <p className="flex items-center">
                ...
                <a href="https://github.com/viratdogra1982" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-300 transition-colors duration-200">
                 github.com/viratdogra1982
                </a>
              </p>
              <p className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-indigo-300" viewBox="0 0 20 20" fill="currentColor">
                ...
                <a href="https://www.linkedin.com/in/virat-dogra-158264327/" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-300 transition-colors duration-200">
                  linkedin.com/in/virat-dogra-158264327/
                </a>
              </p>
            </div>
          </div>
